...
def home(request):
    if request.user.is_authenticated:
        ...
        return render(request, 'bookings/signin.html')
...
def findbus(request):
    ...
    if request.method == 'POST':
        ...
        if bus_list:
            return render(request, 'bookings/list.html', locals())
        else:
            context["error"] = "Sorry no buses availiable"
            return render(request, 'bookings/findbus.html', context)
    else:
        return render(request, 'bookings/findbus.html')
...
def seebookings(request,new={}):
    ...
    if book_list:
        return render(request, 'bookings/booklist.html', locals())
    else:
...
def signup(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            login(request, user)
            return render(request, 'bookings/thank.html')
        else:
            context["error"] = "Provide valid credentials"
            return render(request, 'bookings/signup.html', context)
    else:
        return render(request, 'bookings/signup.html', context)
...
def signin(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            ...
            context["error"] = "Provide valid credentials"
            return render(request, 'bookings/signin.html', context)
    else:
